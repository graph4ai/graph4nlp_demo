...
class GGNNDistMult(torch.nn.Module):
    def __init__(self, 
        ...
        self.emb_e = torch.nn.Embedding(num_entities, 
                                        args.embedding_dim, 
                                        padding_idx=0)
        self.emb_rel = torch.nn.Embedding(num_relations, 
                                          args.embedding_dim, 
                                          padding_idx=0)
        self.num_entities = num_entities
        ...
        # Build GGNN-based encoder
        self.gnn = GGNN(self.num_layers, 
                        args.embedding_dim, 
                        args.embedding_dim,
                        args.embedding_dim,
        ...
        self.loss = torch.nn.BCELoss()
        # Build DistMult decoder
        self.distmult = DistMult(args.input_drop, 
                                 loss_name='BCELoss')
