...
base_path = 'kg_completion/data/{0}/'.format(dataset_name)
...
write_training_graph(test_cases['train.txt'], train_graph['train.txt'], 'kg_completion/data/{0}/e1rel_to_e2_train.json'.format(dataset_name))
write_evaluation_graph(test_cases['valid.txt'], label_graph, join('kg_completion/data/{0}/e1rel_to_e2_ranking_dev.json'.format(dataset_name)))
write_evaluation_graph(test_cases['test.txt'], label_graph, 'kg_completion/data/{0}/e1rel_to_e2_ranking_test.json'.format(dataset_name))
write_training_graph(all_cases, label_graph, 'kg_completion/data/{0}/e1rel_to_e2_full.json'.format(dataset_name))
